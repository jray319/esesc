...
MTLSQ::MTLSQ(GProcessor *gproc_)
  ...
  , stEarlyRetireTime("P(%d)_MTLSQ_stEarlyRetireTime", gproc->getId())
  , nStEarlyRetireByOldSt("P(%d)_MTLSQ_nStEarlyRetireByOldSt", gproc->getId())
  , nStEarlyRetireByStall("P(%d)_MTLSQ_nStEarlyRetireByStall", gproc->getId())
